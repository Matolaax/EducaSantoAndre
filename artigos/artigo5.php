  ...
  <section class="about_section layout_padding">
    ...
    <div class="container">
      <div class="row">
        ...
        <div>
          <p>
            Este texto relata  uma prática pedagógica  de  tematização dos Jogos Mundiais dos Povos Indígenas  nas aulas de Educação Física, na qual as problematizações, reflexões e discussões apresentadas pelas crianças levaram à abordagem  de  questões de gênero e das representações acerca dos povos indígenas.          </p>
          <p>
